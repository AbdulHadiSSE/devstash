...
> Verified against the actual codebase. Only items with implementing code are listed.

### Installed & Configured

| Area | Status | Evidence |
|------|--------|----------|
| Next.js 16 App Router | ✅ | `package.json`, `next.config.ts` |
| React 19 | ✅ | `package.json` |
| TypeScript (strict) | ✅ | `tsconfig.json` |
| Tailwind CSS v4 | ✅ | `src/app/globals.css`, `postcss.config.mjs` |
| React Compiler | ✅ | `next.config.ts` |
...
14. [ ] Set up Vitest and add tests
