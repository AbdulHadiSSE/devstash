...
export function SignInForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (result?.error) {
      setError(
        result.code === "oauth-account-no-password"
          ? "This email is linked to a GitHub sign-in. Use “Sign in with GitHub” instead."
